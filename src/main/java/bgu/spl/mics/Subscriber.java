...
public abstract class Subscriber extends RunnableSubPub {
    ...
    public final void run() {
        ...
        while (!terminated) {
            Message message;
            try {
                System.out.println(this.getName() + " Waiting for a message");
                message = MessageBrokerImpl.getInstance().awaitMessage(this);
                System.out.println(this.getName() + " got a message, start callback : " + message.toString());
